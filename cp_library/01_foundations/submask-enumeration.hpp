...
// CSES: 2419 3308
// Ý nghĩa: liệt kê mọi mặt nạ con của m (theo thứ tự giảm dần, gồm cả 0).
// Tham số: m = mặt nạ bit gốc cần duyệt các tập con.
// Trả về: vector chứa mọi submask của m, xếp giảm dần và luôn có phần tử 0 ở cuối.
